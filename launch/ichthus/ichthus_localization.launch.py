...
def generate_launch_description():
    ...
    ndt_scan_matcher_param_path_default = os.path.join(
        get_package_share_directory('my_launch'), 'param/ndt_scan_matcher.param.yaml'
    )

    vehicle_velocity_converter_param_path_default = os.path.join(
        get_package_share_directory('my_launch'), 'param/vehicle_velocity_converter.param.yaml'
    )

    pose_initializer_param_path_default = os.path.join(
        get_package_share_directory('my_launch'), 'param/pose_initializer.param.yaml'
    )

    voxel_grid_downsample_filter_param_path_default = os.path.join(
        get_package_share_directory('my_launch'), 'param/voxel_grid_filter.param.yaml'
    )
