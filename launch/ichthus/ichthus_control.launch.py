...
def generate_launch_description():
    ...
    lat_controller_param_path_default = os.path.join(
        get_package_share_directory('my_launch'), 'param/lateral_controller.param.yaml'
    )

    lon_controller_param_path_default = os.path.join(
        get_package_share_directory('my_launch'), 'param/longitudinal_controller.param.yaml'
    )

    latlon_muxer_param_path_default = os.path.join(
        get_package_share_directory('my_launch'), 'param/latlon_muxer.param.yaml'
    )

    vehicle_cmd_gate_param_path_default = os.path.join(
        get_package_share_directory('my_launch'), 'param/vehicle_cmd_gate.param.yaml'
    )
