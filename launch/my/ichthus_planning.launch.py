...
def generate_launch_description():
    ...
    behavior_path_planner_param_directory_path_deafult = os.path.join(
        get_package_share_directory('my_launch'), 'param/lane_driving/behavior_planning/behavior_path_planner/'
    )
    
    behavior_velocity_planner_param_directory_path_default = os.path.join(
        get_package_share_directory('my_launch'), 'param/lane_driving/behavior_planning/behavior_velocity_planner/'
    )

    obstacle_planner_param_directory_path_default = os.path.join(
        get_package_share_directory('my_launch'), 'param/lane_driving/motion_planning/'
    )
    
    common_param_path_default = os.path.join(
        get_package_share_directory('my_launch'), 'param/common/common.param.yaml'
    )

    motion_velocity_smoother_param_path_default = os.path.join(
        get_package_share_directory('my_launch'), 'param/common/motion_velocity_smoother/motion_velocity_smoother.param.yaml'
    )

    smoother_param_directory_path_default = os.path.join(
        get_package_share_directory('my_launch'), 'param/common/motion_velocity_smoother/'
    )
